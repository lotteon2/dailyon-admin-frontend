      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="updateCoupon">
          ...
          <div class="form-group">
            ...
            <input type="text" id="couponName" placeholder="적용대상, 할인 값 작성시 자동완성됩니다." v-model="couponUpdateData.name" required />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" id="discountValue" v-model="couponUpdateData.discountValue" min="0" required />
          ...
          <div class="form-group">
            ...
            <input type="number" id="issuedQuantity" v-model="couponUpdateData.issuedQuantity" min="0" required />
            <!-- <span>개</span> -->
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" id="minPurchaseAmount" placeholder="0" v-model="couponUpdateData.minPurchaseAmount" min="0" />
            <!-- <span>원</span> -->
          </div>
          <div class="form-group">
            <label for="maxDiscountAmount">최대 할인금액</label>
            <input type="number" id="maxDiscountAmount" placeholder="필수값이 아닙니다." v-model="couponUpdateData.maxDiscountAmount" min="0" />
            <!-- <span>원</span> -->
          </div>
...
watch(() => couponUpdateData.value.startAt, (newStartAt) => {
  if (newStartAt) {
    couponUpdateData.value.startAt = formatDateForInput(newStartAt);
  }
}, { immediate: true });

watch(() => couponUpdateData.value.endAt, (newEndAt) => {
  if (newEndAt) {
