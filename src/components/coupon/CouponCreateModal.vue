      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="createCoupon">
          ...
          <div class="form-group">
            ...
            <input type="text" id="couponName" placeholder="적용대상, 할인 값 작성시 자동완성됩니다." v-model="couponCreateRequest.name" required />
          </div>
          ...
          <div class="form-group">
            ...
            <div v-if="targetType === 'PRODUCT'">
              <input type="text" id="productSearch" v-model="searchQuery" @input="performSearchProducts" placeholder="상품 검색" autocomplete="off" />
          ...
          <div class="form-group">
            ...
            <input type="number" id="discountValue" v-model="couponCreateRequest.discountValue" min="0" required />
          ...
          <div class="form-group">
            ...
            <input type="datetime-local" id="startAt" v-model="couponCreateRequest.startAt" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" id="issuedQuantity" v-model="couponCreateRequest.issuedQuantity" min="0" required />
            <!-- <span>개</span> -->
          </div>
          ...
          <div class="form-group">
            ...
            <select id="requiresConcurrencyControl" v-model="couponCreateRequest.requiresConcurrencyControl" required>
          ...
          <div class="form-group">
            ...
            <input type="number" id="minPurchaseAmount" placeholder="0" v-model="couponCreateRequest.minPurchaseAmount" min="0" />
            <!-- <span>원</span> -->
          </div>
          <div class="form-group">
            <label for="maxDiscountAmount">최대 할인금액</label>
            <input type="number" id="maxDiscountAmount" placeholder="필수값이 아닙니다." v-model="couponCreateRequest.maxDiscountAmount" min="0" />
            <!-- <span>원</span> -->
          </div>
...
import type { CouponCreateRequest, ReadProductResponse, ReadChildrenCategoryResponse } from "@/apis/coupon/CouponDto";
...
const couponName = computed(() => {
  ...
  if (couponCreateRequest.value.appliesToName) {
    nameParts.push(couponCreateRequest.value.appliesToType === "CATEGORY" 
  ...
  if (couponCreateRequest.value.discountType === "PERCENTAGE") {
    ...
    nameParts.push(`${new Intl.NumberFormat().format(couponCreateRequest.value.discountValue)}원 할인`);
  }
